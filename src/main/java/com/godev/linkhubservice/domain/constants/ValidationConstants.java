...
public class ValidationConstants {
    ...
    public static final String  HREF_LENGTH_ERROR = "O campo href precisa ter entre 7 e 100 caracteres.";
    ...
    public static final String INVALID_IMGUR_URL_FORMAT_ERROR = "O formato esperado de url de imagem é da plataforma Imgur. " +
            "Extensões suportadas: jpg|jpeg|png|gif|bmp.";
    public static final String INVALID_URL_FORMAT_ERROR = "O campo href precisa ser preenchido com um link no formato válido.";
    ...
    public static final String INVALID_BACKGROUND_COLOR_FORMAT_ERROR = "O formato esperado de cor do fundo é em hexadecimal (#cacaca) " +
            "e precisa ter entre 4 e 7 caracteres.";
    public static final String INVALID_TEXT_COLOR_FORMAT_ERROR = "O formato esperado de cor do texto é em hexadecimal (#212121) " +
            "e precisa ter entre 4 e 7 caracteres.";

    public static final String  INVALID_BACKGROUND_TYPE_ERROR = "O tipo esperado de cor de fundo é COLOR ou IMAGE.";
    public static final String  INVALID_BORDER_TYPE_ERROR = "O tipo esperado de cor de borda é SQUARE ou ROUNDED.";
